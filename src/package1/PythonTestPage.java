...
public class PythonTestPage {
	...
	private void initialize() {
		...
		frmAssianInstituteExam.setIconImage(Toolkit.getDefaultToolkit().getImage(JavaTestPage.class.getResource("/images/Alogo.jpg")));
		...
		rdbtnNewRadioButton.setBounds(0, 0, 41, 23);
	...
	public void LoadQuestions(int id) {
		...
		String query = "select * from python_questions where qId = "+id;
//		try {

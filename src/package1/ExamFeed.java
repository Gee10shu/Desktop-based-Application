...
public class ExamFeed {
	...
	private void initialize() {
		...
		frmAssianInstituteOf.setIconImage(Toolkit.getDefaultToolkit().getImage(ExamFeed.class.getResource("/images/Alogo.jpg")));
		...
		frmAssianInstituteOf.getContentPane().add(panel_1_1);
		...
		frmAssianInstituteOf.getContentPane().add(panel_1_2);
		...
		frmAssianInstituteOf.getContentPane().add(panel_1_2_1);

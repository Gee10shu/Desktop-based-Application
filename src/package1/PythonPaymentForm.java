...
public class PythonPaymentForm {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PythonPaymentForm window = new PythonPaymentForm();
	...
	private void initialize() {
		...
		JLabel lblJavaExamEnrollment = new JLabel("Python Exam Enrollment");
